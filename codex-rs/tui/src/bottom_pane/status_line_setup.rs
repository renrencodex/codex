...
impl StatusLineItem {
    fn label(self) -> &'static str {
        match self {
            ...
            StatusLineItem::ModelWithReasoning => "模型与推理强度",
            StatusLineItem::Reasoning => "推理强度",
            StatusLineItem::CurrentDir => "当前目录",
            StatusLineItem::ProjectRoot => "项目",
            StatusLineItem::Hostname => "主机名",
            ...
            StatusLineItem::ContextRemaining => "上下文剩余量",
            StatusLineItem::ContextUsed => "上下文使用量",
            ...
            StatusLineItem::ThreadCredits => "会话额度",
            StatusLineItem::EstimatedThreadCost => "预计会话费用",
            StatusLineItem::SessionId => "会话 ID",
            StatusLineItem::FastMode => "快速模式",
            StatusLineItem::RawOutput => "原始输出",
            StatusLineItem::ThreadName => "会话名称",
            StatusLineItem::ThreadTitle => "会话标题",
    ...
    pub(crate) fn description(self) -> &'static str {
        match self {
            ...
            StatusLineItem::FiveHourLimit => "主要用量限制的剩余额度（不可用时省略）",
            StatusLineItem::WeeklyLimit => "次要用量限制的剩余额度（不可用时省略）",
            StatusLineItem::CodexVersion => "Codex 应用版本",
            StatusLineItem::ContextWindowSize => "上下文窗口令牌总数（未知时省略）",
            ...
            StatusLineItem::EstimatedThreadCost => {
                "当前会话预计美元费用（仅 Enterprise 工作区；不可用时省略）"
            }
            StatusLineItem::SessionId => "当前会话标识符（会话开始前省略）",
            StatusLineItem::FastMode => "快速模式当前是否启用",
            StatusLineItem::RawOutput => "原始回滚模式是否启用",
            StatusLineItem::ThreadName => "当前会话名称（未命名时省略）",
            StatusLineItem::ThreadTitle => "当前会话标题；未命名时显示会话标识符",
            StatusLineItem::WorkspaceHeadline => {
                "工作区通知标题（仅 Enterprise 工作区；不可用时省略）"
            }
